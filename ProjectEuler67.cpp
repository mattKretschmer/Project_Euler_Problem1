/*     / ------- Project Euler 67 ---------
  ...
  Problem Statement: Find maximum path sum from the top to the bottom of a triangle, stored in file big_triangle.txt (code is the same as for problem 18);
*/ 
#include <iostream>
#include <sstream>
#include <string>
